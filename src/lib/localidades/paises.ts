/**
 * Países aceitos no endereço.
 * "name" é o nome em inglês usado pela API countriesnow (estados e cidades) e salvo no
 * banco; o nome em português é gerado na rota /api/countries com Intl.DisplayNames.
 */
export type Pais = { name: string; iso2: string };
...
export const PAISES: Pais[] = [
  ...
  { name: "South Georgia and the South Sandwich Islands", iso2: "GS" },
  { name: "Spain", iso2: "ES" },
