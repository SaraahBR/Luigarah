// src/components/SectionSapatos.tsx
"use client";
...
type Produto = {
  id: number;
  title: string;       // marca
  subtitle: string;    // categoria (Scarpin, Sandália, Bota, etc.)
...
export default function SectionSapatos({
  title = "Sapatos de Luxo – Luigara",
  subtitle = "Scarpins, sandálias, tênis e botas de maisons consagradas.",
  ctaText = "Ver todos",
