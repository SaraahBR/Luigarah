...
export default function HeroGrid() {
  return (
    <section className="w-full grid grid-cols-1 md:grid-cols-2">
      ...
      <div className="bg-[#673024] text-zinc-800 p-8 flex flex-col justify-center items-center text-center aspect-square">
        <h2 className="text-4xl font-light">ESTILO</h2>
        <p className="mt-2 text-sm">FIQUE PRONTO PARA O VERÃO</p>
        <div className="mt-4 border-b border-black w-24"></div>
        <p className="mt-4 text-xs font-semibold">Coleção Masculina</p>
      </div>
