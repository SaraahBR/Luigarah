// src/components/SectionRoupas.tsx
"use client";
...
export default function SectionRoupas({
  title = "Roupas de Luxo – Luigara",
  subtitle = "Vista-se com peças selecionadas de maisons renomadas.",
  ctaText = "Ver todas",
  ...
  // Mantém o mesmo formato usado nas suas pages: { produtos: Produto[] }
