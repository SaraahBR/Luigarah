...
type Produto = {
  id: number;
  title: string;       // marca
  subtitle: string;    // categoria (Saia, Colete, Vestido, etc.)
  ...
  tamanho?: string;    // opcional (S, M, L...), se você quiser usar no drawer
};

const formatBRL = (v: number) =>
  v.toLocaleString("pt-BR", { style: "currency", currency: "BRL", minimumFractionDigits: 0 });

// Cabeçalho apenas para UI
...
export default function Page() {
  ...
  // Pílulas do topo (todas as categorias + algumas marcas populares)
  const topPills = [
